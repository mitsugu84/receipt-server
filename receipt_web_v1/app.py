...
- 推測で埋めないでください。
- 読めない場合は「不明」にしてください。
- 金額は必ずレシート全体を確認して決定してください。
- 商品単価や一部商品の価格を合計金額として採用してはいけません。

【金額】
- レシート下部にある最終支払金額を最優先してください。
- 以下の文字の近くにある金額を優先してください。
  - 合計
  - 合計(税込)
  - 総合計
  - お支払額
  ...
  - クレジット支払額
  - 負担金
- 小計、税額、ポイント、預り金、お釣り、商品単価は合計金額にしないでください。
- 金額にカンマがある場合は必ず反映してください。例: 9,960円 は 9960。
- 不明なら0にしてください。

【日付】
- 「発行日」「領収日」「取引日」「購入日」「調剤日」「診療日」を優先してください。
...
- 「○○様」は宛名なので店名にしないでください。
- 人名を店名として出力しないでください。
- 病院・薬局の領収書では「医療機関」「薬局名」「発行元」の欄を優先してください。
